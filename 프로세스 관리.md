...
<img src ="https://user-images.githubusercontent.com/35948339/126996785-3895c197-5c60-4bde-a2f9-f4e50bc25770.png" width=700>
  ...
  - ### Running State
    ...
    - ### Preemption
      - Running 상태 ➡️ Ready 상태로 변이 되는 것
      - CPU 스케쥴링 (Time-out, 우선순위 변경 ...)
    - ### Block/Sleep
      - Running 상태 ➡️ asleep state
  ...
  - ### Block / Asleep State
    ...
    - ### CPU 외에 다른 자원을 기다리는 상태
      - ❗ 자원 할당은 Kernel의 System call에 의해 이루어진다
    - ### Wake-up
  ...
  - ### Suspended State
    ...
    - ### ❗ 메모리를 빼앗긴 상태
      ...
      - Kernel Or 사용자에 의해 발생
      - #### 💿 다시 메모리를 할당 받으면 Swap device에서 image를 복구하여 다시 진행 
  ...
  - ### Terminated / Zombie State
    ...
    - ### 🔚 프로세스 수행이 끝난 상태
    - ### ⬛ 모든 자원 반납 후, Kernel 내에 일부 PCB 정보만 남아 있는 상태
      - 이후 프로세스 관리를 위해 정보 수집
    - ### ❌ 정보 수집이 끝나면 프로세스를 삭제하고 작업을 마친다
----
  - # 📸 프로세스 상태 한눈에 정리하기
